package com.flowforge.auth_service.invitation.controller;
...
import com.flowforge.auth_service.invitation.dto.CreateInvitationResponse;
import com.flowforge.auth_service.invitation.dto.InvitationInfoResponse;
import com.flowforge.auth_service.invitation.facade.InvitationFacade;
...
public class InvitationController {
    ...
    public ApiResponse<CreateInvitationResponse> createInvitation(@Valid @RequestBody CreateInvitationRequest request,
        ...
        return ApiResponse.success(new CreateInvitationResponse("Invitation sent to "+request.email()), "Invitation sent successfully");
    }
