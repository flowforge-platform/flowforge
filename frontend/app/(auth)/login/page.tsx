          ...
          <div className="w-full max-w-[448px] rounded-xl border border-[#2b2b31] bg-[#171719] px-8 py-8 shadow-[0_28px_70px_rgba(0,0,0,0.42)] sm:px-8">
            ...
            <div className="mt-9">
              ...
              <p className="mt-2 text-base text-[#bbb8c9]">
                Access your distributed workflows
              </p>
            </div>
            ...
            <form className="mt-9 space-y-6" noValidate onSubmit={handleSubmit}>
              <div>
                <label
                  className="font-mono text-sm text-[#f0edf6]"
                  htmlFor="email"
                >
                  Email Address
                </label>
                <div
                  className={`mt-3 flex h-14 items-center rounded-md border bg-[#09090c] px-4 transition focus-within:border-[#b9b7ff] ${
                    errors.email ? "border-red-400/70" : "border-[#464657]"
                  }`}
                >
                  <AtSign className="mr-3 size-5 text-[#a1a0b2]" />
                  <input
              ...
              <div>
                <div className="flex items-center justify-between gap-4">
                  ...
                  <button
                    className="text-xs font-medium text-[#c2c0ff] transition hover:text-[#d4d2ff]"
                    type="button"
                  >
                    Forgot password?
                  </button>
                ...
                >
                  <LockKeyhole className="mr-3 size-5 text-[#a1a0b2]" />
                  <input
                    aria-invalid={Boolean(errors.password)}
                    className="h-full min-w-0 flex-1 bg-transparent text-base text-[#f4f4f7] outline-none placeholder:text-[#666679]"
                    id="password"
                    name="password"
                    onChange={(event) => {
            ...
            <div className="relative my-8 flex items-center justify-center">
              <div className="h-px w-full bg-[#2c2c33]" />
              <span className="absolute bg-[#171719] px-3 text-xs text-[#c5c2d2]">
                Or continue with
              </span>
            </div>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <Button
                className="h-14 rounded-md border-[#303038] bg-transparent p-0 text-base text-[#eeeeef] hover:bg-[#222228]"
            ...
            <p className="mt-8 text-center text-sm text-[#c6c3d0]">
              Don&apos;t have an account?{" "}
              <button
                className="font-semibold text-[#c2c0ff] transition hover:text-[#d4d2ff]"
                onClick={goToRegister}
                type="button"
              >
                Create account
